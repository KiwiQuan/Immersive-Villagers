...
| **4**     | **Working Memory**          | Active state. Tracks immediate focus and "shocks" (e.g., taking damage) via **in-memory cache** (`trackedVillagers`). DPs for backup persistence only. |
