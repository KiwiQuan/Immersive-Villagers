...
To ensure the "Personality Tags" feel active, Layer 7 runs a background "Idle Controller":
...
- **Safety Gate:** If a villager takes damage (P0 event from Layer 1), Layer 8 should automatically override any current command with an immediate **FLEE()** until the brain decides otherwise.
