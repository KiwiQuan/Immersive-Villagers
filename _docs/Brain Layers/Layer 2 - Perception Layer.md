...
Converts raw game data and locations into a 5-axis Emotional/Social vector. This allows the brain to understand the "vibe" of an action (e.g., "Harmful High-Energy Social" vs "Helpful Low-Energy Solo").
